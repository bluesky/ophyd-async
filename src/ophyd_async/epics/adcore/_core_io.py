...
class NDPluginStatsIO(NDPluginBaseIO):
    ...
    total_array: A[SignalRW[float], PvSuffix("TotalArray", "Total_RBV")]
    # Centroid statistics
    ...
    profile_size_x: A[SignalR[int], PvSuffix("ProfileSizeX")]
    profile_size_y: A[SignalR[int], PvSuffix("ProfileSizeY")]
