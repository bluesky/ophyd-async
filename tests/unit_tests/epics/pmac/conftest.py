...
async def sim_motors():
    ...
    set_mock_value(sim_x_motor.low_limit_travel, -20.0)
    set_mock_value(sim_x_motor.high_limit_travel, 20.0)
    set_mock_value(sim_y_motor.low_limit_travel, -20.0)
    set_mock_value(sim_y_motor.high_limit_travel, 20.0)
...
async def sim_cs_motors():
    ...
    set_mock_value(sim_cs_x_motor.low_limit_travel, -20.0)
    set_mock_value(sim_cs_x_motor.high_limit_travel, 20.0)
    set_mock_value(sim_cs_y_motor.low_limit_travel, -20.0)
    set_mock_value(sim_cs_y_motor.high_limit_travel, 20.0)
