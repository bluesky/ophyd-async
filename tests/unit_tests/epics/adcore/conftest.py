...
#         # Create the static path provider here to allow for overriding the directory
#         # URI
...
#                     f"{value}/{static_filename_provider(
# device_name=test_adstandard_det.name)}{test_adstandard_det._writer._file_extension}",
#                 )
