...
@pytest.mark.parametrize(
    ...
    [
        ...
        (npt.NDArray[np.int8], [0], [-8, 3, 44], waveform_d, "|i1"),
        (npt.NDArray[np.uint8], [0], [218], waveform_d, "|u1"),
        (npt.NDArray[np.int16], [0], [-855], waveform_d, "<i2"),
        (npt.NDArray[np.uint16], [0], [5666], waveform_d, "<u2"),
        (npt.NDArray[np.int32], [0], [-2], waveform_d, "<i4"),
        (npt.NDArray[np.uint32], [0], [1022233], waveform_d, "<u4"),
        (npt.NDArray[np.int64], [0], [-3], waveform_d, "<i8"),
        (npt.NDArray[np.uint64], [0], [995444], waveform_d, "<u8"),
        (npt.NDArray[np.float32], [0], [1.0], waveform_d, "<f4"),
        (npt.NDArray[np.float64], [0], [0.2], waveform_d, "<f8"),
        (Sequence[str], ["test"], ["nine", "ten"], waveform_d, ""),
