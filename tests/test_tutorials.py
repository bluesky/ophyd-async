...
@pytest.mark.parametrize("module", ["ophyd_async.sim", "ophyd_async.epics.demo", "ophyd_async.fastcs.demo"])
async def test_implementing_devices(module, capsys, expected_scan_output):
